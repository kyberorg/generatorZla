...
public class Main {
    ...
    public static void setFont() throws Exception {
        String fontLocation = "tahoma.ttf"; //using font supplied with generator
        //fontLocation = "/usr/local/share/fonts/tahoma.ttf"; //you should add font to this location before run
